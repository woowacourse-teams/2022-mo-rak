...
import static com.morak.back.brandnew.AuthFixture.createMember;
import static com.morak.back.brandnew.AuthFixture.createTeam;
...
class PollTest {
    ...
    private NewPollItem itemA;
    private NewPollItem itemB;
    private NewPollItem itemC;
    ...
    void setUp() {
        PollInfo info = PollInfo.builder()
                ...
                .closedAt(SystemDateTime.builder()
                        ...
                        .build())
                .build();
        itemA = NewPollItem.builder()
                .id(1L)
                .subject("삼겹살")
                .build();
        itemB = NewPollItem.builder()
                .id(2L)
                .subject("회")
                .build();
        itemC = NewPollItem.builder()
                .id(3L)
                .subject("이자카야")
                .build();
        poll = NewPoll.builder()
                .pollInfo(info)
    ...
    void 투표_생성시_투표_항목_개수가_허용_개수보다_적으면_예외를_던진다() {
        ...
        // when & then
        assertThatThrownBy(() -> poll = NewPoll.builder()
                .pollInfo(info)
                .pollItems(List.of(itemA, itemB, itemC))
                .build())
                .isInstanceOf(PollDomainLogicException.class)
    ...
    void 투표를_진행한다() {
        // given
        Map<NewPollItem, String> selectData = new HashMap<>();
    ...
    void 투표에_속하지_않은_선택항목에_투표하려는_경우_예외를_던진다() {
        // given
        NewPollItem itemD = NewPollItem.builder()
                .id(4L)
                .subject("서브웨이")
                .build();
