...
public class SimpleMockMvc {
    ...
    public static ResultActions put(MockMvc mockMvc, String path, String groupCode, String menuCode, Object request) throws Exception {
    ...
    public static ResultActions patch(MockMvc mockMvc, String path, String groupCode, String menuCode) throws Exception {
        return mockMvc.perform(RestDocumentationRequestBuilders.patch(path, groupCode, menuCode)
                .header("Authorization", "bearer access.token"));
    }

    public static ResultActions delete(MockMvc mockMvc, String path, String groupCode, String menuCode) throws Exception {
