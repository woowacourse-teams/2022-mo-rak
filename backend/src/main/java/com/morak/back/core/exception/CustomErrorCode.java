...
public enum CustomErrorCode {
    ...
    PROFILE_URL_BLANK_ERROR("0104", "멤버의 프로필은 공백일 수 없습니다."),
    PROFILE_URL_LENGTH_ERROR("0105", "멤버의 프로필 길이가 올바르지 않습니다."),
    PROFILE_URL_PATTERN_ERROR("0106", "멤버의 프로필 형식이 올바르지 않습니다."),
    ...
    POLL_DESCRIPTION_LENGTH_ERROR("2106", "투표 선택 이유의 길이가 올바르지 않습니다."),
