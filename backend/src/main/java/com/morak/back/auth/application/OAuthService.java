...
public class OAuthService {
    ...
    public OAuthService(Member2Repository memberRepository, OAuthClient oAuthClient, TokenProvider tokenProvider) {
    ...
    public SigninResponse signin(SigninRequest request) {
        OAuthMemberInfoResponse memberResponse = getOAuthMemberInfo(request);
    ...
    private OAuthMemberInfoResponse getOAuthMemberInfo(SigninRequest request) {
        try {
